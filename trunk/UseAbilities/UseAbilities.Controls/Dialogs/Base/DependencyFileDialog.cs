...
namespace UseAbilities.Controls.Dialogs.Base
{
    /// <summary>
    ...
    public abstract class DependencyFileDialog : Control
    {
        ...
        /// </summary>
        protected DependencyFileDialog()
        {
            Visibility = Visibility.Collapsed;
            if (Dialog == null) return;
            
            Dialog.FileOk += DialogFileOk;
        }
        ...
        {
            if (FileOkCommand != null) FileOkCommand.Execute(Dialog.FileName);
        }
        ...
        public bool AddExtension
        {
            get
            {
                return (bool)GetValue(AddExtensionProperty);
            }
            set
            {
        ...
        public bool CheckFileExists
        {
            get
            {
                return (bool)GetValue(CheckFileExistsProperty);
            }
            set
            {
        ...
        public bool CheckPathExists
        {
            get
            {
                return (bool)GetValue(CheckPathExistsProperty);
            }
            set
            {
        ...
        public IList<FileDialogCustomPlace> CustomPlaces
        {
            get
            {
                return (IList<FileDialogCustomPlace>)GetValue(CustomPlacesProperty);
            }
            set
            {
        ...
        public bool DereferenceLinks
        {
            get
            {
                return (bool)GetValue(DereferenceLinksProperty);
            }
            set
            {
        ...
        {
            var dfd = obj as DependencyFileDialog;
            if (dfd == null) return;
        ...
        public ICommand ShowDialogCommand
        {
            get
            {
                return _showDialogCommand ?? (_showDialogCommand = new RelayCommand(p => Dialog.ShowDialog()));
                //if (showDialogCommand == null)
                //{
                //    showDialogCommand = new DelegateCommand(p => Dialog.ShowDialog());
                //}
